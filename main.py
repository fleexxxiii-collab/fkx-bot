...
BOT_TOKEN = "8394617212:AAEdSyV_RlgmZV10BWp_QJCnDDN8rBSvCV4"

OWNER_IDS = [6047449871, 7194533012]
...
# =========================
# IMAGE FILE ID (NEW SYSTEM)
# =========================
FKX_IMAGE = "AgACAgQAAxkBAAMDahmlmH-4AVco8C7bVuSHkYXUHdYAAmANaxuqIshQnXkNJLhEpYMBAAMCAAN5AAM7BA"
...
def other(message):
    ...
    bot.send_message(
        message.chat.id,
        "📩 Please DM the owner for other services @ET_FLEXI OR FKX_MARKETT."
    )
